...
class InstagramDismiss extends StatefulWidget {
  final Widget child;
  ...
  @override
  _InstagramDismissState createState() => _InstagramDismissState();
}

class _InstagramDismissState extends State<InstagramDismiss>
    ...
    return GestureDetector(
      ...
      onPanUpdate: (details) {
        if (details.delta.dy > 0) {
          print('$wasLastDragGrowth positive');
          wasLastDragGrowth = false;
          verticalDrag = verticalDrag + details.delta.dy;
        } else if (details.delta.dy < 0) {
          print('$wasLastDragGrowth negative');
          if (verticalDrag > 0) {
            verticalDrag = verticalDrag + details.delta.dy;
          }
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return Transform.scale(
                scale: 1 * (1 - verticalDrag / 8000),
                child: Transform.translate(
                  offset: Offset(0, verticalDrag * 0.8),
                  child: child,
                ),
              );
            },
